 ...
 * The first element of the list otherwise (note that the actual element is
 * returned, and not a copy of it).
 */
 ...
 * The next element on the list in case of success (note that the actual element
 * is returned, and not a copy of it).
 */
 ...
 * The current element on the list in case of success (note that the actual
 * element is returned, and not a copy of it).
 */
