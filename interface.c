...
static void printTopDish(Tournament tournament) {
	...
	char* dishName;
	TournamentResult result = tournamentGetTopDish(tournament, chefName, 
		&dishName);
...
static void addJudge (Tournament tournament) {
	...
	TournamentResult result = tournamentAddJudge(tournament, nickname, 
		judgeByPreference);
...
static void printJudges (Tournament tournament) {
	char ** judges;
	int numberOfJudges;
	TournamentResult result = tournamentGetJudges(tournament, &judges, 
		&numberOfJudges);
...
static void addDish (Tournament tournament) {
	...
	int saltiness = atoi(strtok(NULL," \n"));
	int priority = atoi(strtok(NULL," \n"));
	Taste taste = {sweetness, sourness, saltiness};
	TournamentResult result = tournamentAddDishToChef(tournament, chefName, 
		dishName, dishType, taste, priority);
	switch(result) {
